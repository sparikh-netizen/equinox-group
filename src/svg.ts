...
import { COMPANY, DESIGN, PAGE, PATHS } from "./config.js";
import type { Employee } from "./employee.js";
import { qrPathForSvg } from "./qr.js";
...
<svg xmlns="http://www.w3.org/2000/svg" width="94.9mm" height="56.8mm" viewBox="0 0 ${PAGE.width} ${PAGE.height}">
  ...
  <style>
    @font-face { font-family: Manrope; font-style: normal; font-weight: 400; src: url(data:font/ttf;base64,${regular.toString("base64")}); }
    @font-face { font-family: Manrope; font-style: normal; font-weight: 700; src: url(data:font/ttf;base64,${bold.toString("base64")}); }
    @font-face { font-family: Manrope; font-style: normal; font-weight: 800; src: url(data:font/ttf;base64,${extraBold.toString("base64")}); }
